...
import (
	...
	"github.com/a-aslani/wotop/examples/ddd/configs"
	"github.com/a-aslani/wotop/wotop_jwt"
...
type controller struct {
	...
	log                     wotop_logger.Logger  // Logger for logging application events.
	cfg                     *configs.Config      // Configuration settings for the application.
	jwt                     wotop_jwt.JWT        // JWT handler for managing JSON Web Tokens.
...
func NewController(appData wotop.ApplicationData, log wotop_logger.Logger, cfg *configs.Config, jwt wotop_jwt.JWT) wotop.ControllerRegisterer {
