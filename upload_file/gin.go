...
func UploadWithFileSize(c *gin.Context, params Params) (string, int64, error) {
	...
	if fileHeader.Size > params.MaxSize {
		return "", 0, ErrFileSizeExceeds.Var(params.MaxSize)
	}
	...
	if !isAccept {
		return "", 0, ErrInvalidFileType.Var(mimeType)
	}
	...
	return filePath, fileHeader.Size, nil
}
